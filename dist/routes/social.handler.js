...
socialHandler.put('/posts/:id', authMiddleware, validationMiddleware({
...
socialHandler.get('/posts/trending', authMiddleware, validationMiddleware({ query: SocialSchemas.trendingPostsQuery }), async (c) => {
    try {
        const query = c.get('validatedQuery');
...
socialHandler.get('/posts/search', authMiddleware, validationMiddleware({ query: SocialSchemas.searchPostsQuery }), async (c) => {
    try {
        const query = c.get('validatedQuery');
...
socialHandler.delete('/posts/:id/like', authMiddleware, validationMiddleware({ params: SocialSchemas.getPostParams }), async (c) => {
    try {
        const params = c.get('validatedParams');
...
socialHandler.post('/posts/:id/comments', authMiddleware, validationMiddleware({
    params: SocialSchemas.getPostParams,
...
socialHandler.get('/posts/:id/comments', authMiddleware, validationMiddleware({
    params: SocialSchemas.getPostParams,
...
socialHandler.delete('/posts/:id/comments/:commentId', authMiddleware, validationMiddleware({ params: SocialSchemas.deleteCommentParams }), async (c) => {
    try {
        const params = c.get('validatedParams');
...
socialHandler.post('/posts/:id/share', authMiddleware, validationMiddleware({
    params: SocialSchemas.getPostParams,
...
socialHandler.post('/posts/:id/repost', authMiddleware, validationMiddleware({
    params: SocialSchemas.getPostParams,
...
socialHandler.post('/follow/:id', authMiddleware, validationMiddleware({ params: SocialSchemas.followUserParams }), async (c) => {
    try {
        const params = c.get('validatedParams');
...
socialHandler.delete('/follow/:id', authMiddleware, validationMiddleware({ params: SocialSchemas.followUserParams }), async (c) => {
    try {
        const params = c.get('validatedParams');
...
socialHandler.get('/followers/:id', validationMiddleware({
...
socialHandler.get('/following/:id', validationMiddleware({
    params: SocialSchemas.followUserParams,
    query: SocialSchemas.paginationQuery
}), async (c) => {
    try {
...
socialHandler.get('/feed', authMiddleware, validationMiddleware({ query: SocialSchemas.feedQuery }), async (c) => {
    try {
        const query = c.get('validatedQuery');
