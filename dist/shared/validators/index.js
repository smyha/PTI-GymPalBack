...
export const StringSchema = (minLength = 1, maxLength = 255) => z.string().min(minLength, `Must be at least ${minLength} characters`).max(maxLength, `Must be no more than ${maxLength} characters`);
// Common array schema with length validation
export const ArraySchema = (maxLength = 100) => z.array(z.string()).max(maxLength, `Array cannot exceed ${maxLength} items`);
// ============================================================================
