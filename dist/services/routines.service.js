...
export async function createRoutine(c, body) {
    try {
...
// Get routine by ID
export async function getRoutine(c, routineId) {
    try {
        const { data: routine, error } = await supabase
            .from('routines')
            .select(`
...
// Update routine
export async function updateRoutine(c, routineId, body) {
    try {
        const userId = c.get('userId');
        const { name, description, difficulty, workouts, tags, is_public, schedule } = body;
...
// Delete routine
export async function deleteRoutine(c, routineId) {
    try {
        const userId = c.get('userId');
        // Check if routine exists and belongs to user
        const { data: existingRoutine, error: checkError } = await supabase
...
// Get user routines
export async function getUserRoutines(c, userId, limit = 20, offset = 0) {
    try {
...
// Get public routines
export async function getPublicRoutines(c, limit = 20, offset = 0, difficulty, tags) {
    try {
        let query = supabase
            .from('routines')
            .select(`
...
// Search routines
export async function searchRoutines(c, query, limit = 20, offset = 0) {
    try {
        const { data: routines, error } = await supabase
            .from('routines')
            .select(`
...
// Like routine
export async function likeRoutine(c, routineId) {
    try {
        const userId = c.get('userId');
...
// Unlike routine
export async function unlikeRoutine(c, routineId) {
    try {
        const userId = c.get('userId');
        // Remove like
        const { error } = await supabase
...
// Get routine likes
export async function getRoutineLikes(c, routineId, limit = 20, offset = 0) {
    try {
...
export async function getRoutineStats(c, routineId) {
    try {
        // Get routine
        const { data: routine, error: routineError } = await supabase
            .from('routines')
...
// Start routine
export async function startRoutine(c, routineId) {
    try {
        const userId = c.get('userId');
        // Check if routine exists
        const { data: routine, error: routineError } = await supabase
...
// Complete routine
export async function completeRoutine(c, routineId) {
    try {
        const userId = c.get('userId');
...
// List routines
export async function listRoutines(c, query = {}) {
    try {
        const userId = c.get('userId');
...
export async function useRoutine(c, routineId) {
    return startRoutine(c, routineId);
}
// Duplicate routine
export async function duplicateRoutine(c, routineId, body) {
    try {
        const userId = c.get('userId');
...
export async function getRoutineExercises(c, routineId) {
    try {
...
export async function addExerciseToRoutine(c, routineId, body) {
    try {
...
export async function updateRoutineExercise(c, routineId, exerciseId, body) {
    try {
        const { data: exercise, error } = await supabase
            .from('routine_workouts')
            .update(body)
...
export async function removeExerciseFromRoutine(c, routineId, exerciseId) {
    try {
        const { error } = await supabase
            .from('routine_workouts')
            .delete()
...
export async function getRoutineCategories(c) {
    try {
        const categories = [
