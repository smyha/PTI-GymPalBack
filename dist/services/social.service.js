...
// Create a new post
export async function createPost(c, body) {
    try {
...
// Get post by ID
export async function getPost(c, postId) {
    try {
        const { data: post, error } = await supabase
            .from('posts')
            .select('*')
...
// Update post
export async function updatePost(c, postId, body) {
    try {
        const userId = c.get('userId');
...
// Delete post
export async function deletePost(c, postId) {
    try {
        const userId = c.get('userId');
        // Check if post exists and belongs to user
        const { data: existingPost, error: checkError } = await supabase
...
// Get feed posts
export async function getFeedPosts(c, limit = 20, offset = 0) {
    try {
...
// Get user posts
export async function getUserPosts(c, userId, limit = 20, offset = 0) {
    try {
        const { data: posts, error } = await supabase
            .from('posts')
            .select('*')
...
// Search posts
export async function searchPosts(c, query, limit = 20, offset = 0) {
    try {
        const { data: posts, error } = await supabase
            .from('posts')
            .select(`
...
// Like post
export async function likePost(c, postId) {
    try {
        const userId = c.get('userId');
...
// Unlike post
export async function unlikePost(c, postId) {
    try {
        const userId = c.get('userId');
        // Remove like
        const { error } = await supabase
...
// Get post likes
export async function getPostLikes(c, postId, limit = 20, offset = 0) {
    try {
...
// Create comment
export async function createComment(c, postId, body) {
    try {
        const userId = c.get('userId');
...
// Get post comments
export async function getPostComments(c, postId, limit = 20, offset = 0) {
    try {
...
// Delete comment
export async function deleteComment(c, commentId) {
    try {
        const userId = c.get('userId');
...
// Get post statistics
export async function getPostStats(c, postId) {
    try {
        // Get post
        const { data: post, error: postError } = await supabase
            .from('posts')
...
// List posts
export async function listPosts(c, query = {}) {
    try {
...
// Get trending posts
export async function getTrendingPosts(c, query = {}) {
    try {
        const { page = 1, limit = 20 } = query;
        const offset = (parseInt(page) - 1) * parseInt(limit);
        const { data: posts, error, count } = await supabase
...
export async function addComment(c, postId, body) {
    return createComment(c, postId, body);
}
// Share post
export async function sharePost(c, postId, body) {
    try {
        const userId = c.get('userId');
...
// Repost
export async function repost(c, postId, body) {
    try {
        const userId = c.get('userId');
...
// ============================================================================
// Follow user
export async function followUser(c, targetUserId) {
    try {
        const userId = c.get('userId');
...
// Unfollow user
export async function unfollowUser(c, targetUserId) {
    try {
        const userId = c.get('userId');
...
// Get user followers
export async function getUserFollowers(c, userId, query = {}) {
    try {
        const { page = 1, limit = 20 } = query;
        const offset = (parseInt(page) - 1) * parseInt(limit);
...
// Get user following
export async function getUserFollowing(c, userId, query = {}) {
    try {
        const { page = 1, limit = 20 } = query;
        const offset = (parseInt(page) - 1) * parseInt(limit);
...
// Get user feed
export async function getUserFeed(c, query = {}) {
    try {
        const userId = c.get('userId');
        const { page = 1, limit = 20 } = query;
        const offset = (parseInt(page) - 1) * parseInt(limit);
