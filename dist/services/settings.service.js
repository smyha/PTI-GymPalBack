...
export async function updateNotificationPreferences(c, body) {
    try {
        const userId = c.get('userId');
...
export async function updatePrivacySettings(c, body) {
    try {
        const userId = c.get('userId');
...
export async function updateUnitsPreferences(c, body) {
    try {
        const userId = c.get('userId');
...
export async function updateThemePreferences(c, body) {
    try {
        const userId = c.get('userId');
...
// Update language
export async function updateLanguage(c, body) {
    try {
        const userId = c.get('userId');
        const { language } = body;
        // Validate language
...
// Update timezone
export async function updateTimezone(c, body) {
    try {
        const userId = c.get('userId');
        const { timezone } = body;
        // Validate timezone
...
export async function getAvailableLanguages(c) {
    try {
        const languages = [
...
export async function getAvailableTimezones(c) {
    try {
...
// Export user data
export async function exportUserData(c, body) {
    try {
        const userId = c.get('userId');
        // Get user profile
...
// Delete user account
export async function deleteAccount(c) {
    try {
        const userId = c.get('userId');
        // Delete user profile
...
export async function getNotificationSettings(c) {
    try {
        const userId = c.get('userId');
        const { data: settings, error } = await supabase
            .from('user_settings')
...
export async function updateNotificationSettings(c, body) {
    return updateNotificationPreferences(c, body);
}
// Get privacy settings
export async function getPrivacySettings(c) {
    try {
        const userId = c.get('userId');
        const { data: settings, error } = await supabase
            .from('user_settings')
...
export async function getUserPreferences(c) {
    try {
        const userId = c.get('userId');
        const { data: settings, error } = await supabase
            .from('user_settings')
...
export async function updateUserPreferences(c, body) {
    try {
        const userId = c.get('userId');
        const updates = {};
        if (body.theme)
...
export async function getFitnessSettings(c) {
    try {
        const userId = c.get('userId');
        const { data: settings, error } = await supabase
            .from('user_settings')
...
export async function updateFitnessSettings(c, body) {
    try {
        const userId = c.get('userId');
        const { data: settings, error } = await supabase
            .from('user_settings')
...
// Get social settings
export async function getSocialSettings(c) {
    try {
        const userId = c.get('userId');
        const { data: settings, error } = await supabase
            .from('user_settings')
...
export async function updateSocialSettings(c, body) {
    return updatePrivacySettings(c, body);
}
// Import user data
export async function importUserData(c, body) {
    try {
        const userId = c.get('userId');
...
export async function deleteUserAccount(c, body) {
    return deleteAccount(c);
}
// Get activity log
export async function getActivityLog(c, query = {}) {
    try {
        const userId = c.get('userId');
