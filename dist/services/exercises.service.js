...
export async function createExercise(c, body) {
    try {
...
// Get all exercises
export async function getAllExercises(c) {
...
// Get exercise by ID
export async function getExerciseById(c) {
    try {
...
// Update exercise
export async function updateExercise(c, exerciseId, body) {
    try {
        const userId = c.get('userId');
        if (!userId) {
            return sendError(c, ERROR_CODES.UNAUTHORIZED, API_MESSAGES.UNAUTHORIZED, 401);
...
// Delete exercise
export async function deleteExercise(c, exerciseId) {
    try {
        const userId = c.get('userId');
        if (!userId) {
            return sendError(c, ERROR_CODES.UNAUTHORIZED, API_MESSAGES.UNAUTHORIZED, 401);
...
export async function getExerciseCategories(c) {
    try {
...
export async function getMuscleGroups(c) {
    return getExerciseCategories(c);
}
// Get equipment types
export async function getEquipmentTypes(c) {
    try {
...
// Search exercises
export async function searchExercises(c, query) {
    try {
        const userId = c.get('userId');
        if (!userId) {
            return sendError(c, ERROR_CODES.UNAUTHORIZED, API_MESSAGES.UNAUTHORIZED, 401);
...
export async function getUserExercises(c) {
    try {
        const userId = c.get('userId');
        if (!userId) {
            return sendError(c, ERROR_CODES.UNAUTHORIZED, API_MESSAGES.UNAUTHORIZED, 401);
