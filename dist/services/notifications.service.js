...
export async function updateNotificationSettings(c, body) {
    try {
        const userId = c.get('userId');
        const { email, push, sms, workout_reminders, social_updates, achievement_unlocks, weekly_reports, new_follower, new_like, new_comment, new_share, workout_reminder_time, weekly_report_day } = body;
...
export async function sendWorkoutReminder(c) {
    try {
        const userId = c.get('userId');
...
export async function getWorkoutReminders(c) {
    try {
        const userId = c.get('userId');
...
export async function deleteWorkoutReminder(c) {
    try {
        const userId = c.get('userId');
...
export async function getNotificationStats(c) {
    try {
        const userId = c.get('userId');
