...
socialHandler.get(
  '/posts',
  authMiddleware,
  validationMiddleware({ query: SocialSchemas.listPostsQuery }), async (c) => {
  try {
...
socialHandler.post(
  '/posts',
  authMiddleware,
  validationMiddleware({ body: SocialSchemas.createPostBody }), async (c) => {
  try {
...
socialHandler.get(
  '/posts/:id', 
  authMiddleware, 
  validationMiddleware({ params: SocialSchemas.getPostParams }), async (c) => {
  try {
    return await getPost(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
socialHandler.put(
  '/posts/:id',
  authMiddleware, 
  validationMiddleware({ params: SocialSchemas.getPostParams, body: SocialSchemas.updatePostBody }), async (c) => {
  try {
    return await updatePost(c, (c.get('validatedParams') as { id: string }).id, c.get('validatedBody'));
  } catch (error: any) {
...
socialHandler.delete(
  ...
  validationMiddleware({ params: SocialSchemas.getPostParams }), async (c) => {
  try {
    return await deletePost(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
socialHandler.post(
  ...
  validationMiddleware({ params: SocialSchemas.getPostParams }), async (c) => {
  try {
    return await likePost(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
socialHandler.get(
  ...
  validationMiddleware({ params: SocialSchemas.getPostParams }), async (c) => {
  try {
    return await getPostComments(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
socialHandler.post(
  ...
  async (c) => {
  try {
    return await createComment(c, (c.get('validatedParams') as { id: string }).id, c.get('validatedBody'));
  } catch (error: any) {
...
socialHandler.delete(
  '/comments/:commentId', 
  authMiddleware, validationMiddleware({ params: SocialSchemas.deleteCommentParams }), 
  async (c) => {
  try {
    return await deleteComment(c, (c.get('validatedParams') as { commentId: string }).commentId);
  } catch (error: any) {
...
socialHandler.post(
  ...
  async (c) => {
  try {
    return await followUser(c, (c.get('validatedParams') as { userId: string }).userId);
  } catch (error: any) {
...
socialHandler.post(
  ...
  async (c) => {
  try {
    return await unfollowUser(c, (c.get('validatedParams') as { userId: string }).userId);
  } catch (error: any) {
...
socialHandler.get(
  ...
  authMiddleware, 
  validationMiddleware({ params: SocialSchemas.followUserParams, query: SocialSchemas.listPostsQuery }), 
  async (c) => {
  try {
    return await getUserFollowers(c, (c.get('validatedParams') as { userId: string }).userId, c.get('validatedQuery'));
  } catch (error: any) {
...
socialHandler.get(
  ...
  async (c) => {
  try {
    return await getUserFollowing(c, (c.get('validatedParams') as { userId: string }).userId, c.get('validatedQuery'));
  } catch (error: any) {
