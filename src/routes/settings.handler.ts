...
settingsHandler.put(
  '/privacy',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.updatePrivacySettingsBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.put(
  '/preferences',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.updateUserPreferencesBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.put(
  '/fitness',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.updateFitnessSettingsBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.put(
  '/social',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.updateSocialSettingsBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.post(
  '/export-data',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.exportUserDataBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.post(
  '/import-data',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.importUserDataBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.delete(
  '/account',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.deleteUserAccountBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.get(
  '/activity-log',
  authMiddleware,
  validationMiddleware({ query: SettingsSchemas.activityLogQuery }),
  async (c) => {
    try {
...
settingsHandler.post(
  '/change-email',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.changeEmailBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
...
settingsHandler.post(
  '/verify-email-change',
  authMiddleware,
  validationMiddleware({ body: SettingsSchemas.verifyEmailChangeBody }),
  async (c) => {
    try {
      const body = c.get('validatedBody');
