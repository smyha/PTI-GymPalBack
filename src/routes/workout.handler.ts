...
workoutHandler.get(
  '/', 
  authMiddleware, 
  validationMiddleware(WorkoutSchemas.listWorkoutsQuery), 
  async (c) => {
  try {
...
workoutHandler.post(
  '/', 
  authMiddleware, 
  validationMiddleware(WorkoutSchemas.createWorkoutBody), 
  async (c) => {
  try {
...
workoutHandler.get(
  '/:id', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getWorkoutParams }), 
  async (c) => {
  try {
    return await getWorkout(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
workoutHandler.put(
  '/:id', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getWorkoutParams, body: WorkoutSchemas.updateWorkoutBody }), 
  async (c) => {
  try {
    return await updateWorkout(c, (c.get('validatedParams') as { id: string }).id, c.get('validatedBody'));
  } catch (error: any) {
 ...
 *         $ref: '#/components/responses/NotFoundError'
 */
workoutHandler.delete(
  '/:id', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getWorkoutParams }), 
  async (c) => {
  try {
    return await deleteWorkout(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
workoutHandler.get(
  ...
  async (c) => {
  try {
    return await getWorkoutExercises(c, (c.get('validatedParams') as { id: string }).id);
  } catch (error: any) {
...
workoutHandler.post(
  '/:id/exercises', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getWorkoutParams, body: WorkoutSchemas.addExerciseBody }), 
  async (c) => {
  try {
    return await addExerciseToWorkout(c, (c.get('validatedParams') as { id: string }).id, c.get('validatedBody'));
  } catch (error: any) {
...
workoutHandler.put(
  ...
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.updateExerciseParams, body: WorkoutSchemas.updateExerciseBody }), 
  async (c) => {
  try {
    const params = c.get('validatedParams') as { id: string; exerciseId: string };
...
workoutHandler.delete(
  '/:id/exercises/:exerciseId', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.updateExerciseParams }), 
  async (c) => {
  try {
    const params = c.get('validatedParams') as { id: string; exerciseId: string };
...
workoutHandler.post(
  '/:id/start', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getWorkoutParams, body: WorkoutSchemas.startWorkoutBody }), 
  async (c) => {
  try {
    return await startWorkoutSession(c, (c.get('validatedParams') as { id: string }).id, c.get('validatedBody'));
  } catch (error: any) {
...
workoutHandler.post(
  '/:id/complete', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getWorkoutParams, body: WorkoutSchemas.completeWorkoutBody }), 
  async (c) => {
  try {
    return await completeWorkoutSession(c, (c.get('validatedParams') as { id: string }).id, c.get('validatedBody'));
  } catch (error: any) {
...
workoutHandler.get(
  '/sessions', 
  authMiddleware, 
  validationMiddleware({ query: WorkoutSchemas.listSessionsQuery }), 
  async (c) => {
  try {
...
workoutHandler.get('/sessions/:sessionId', authMiddleware, validationMiddleware({ params: WorkoutSchemas.getSessionParams }), async (c) => {
  try {
    return await getWorkoutSession(c, (c.get('validatedParams') as { sessionId: string }).sessionId);
  } catch (error: any) {
...
workoutHandler.put(
  '/sessions/:sessionId', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getSessionParams, body: WorkoutSchemas.updateSessionBody }), 
  async (c) => {
  try {
    return await updateWorkoutSession(c, (c.get('validatedParams') as { sessionId: string }).sessionId, c.get('validatedBody'));
  } catch (error: any) {
...
workoutHandler.delete(
  '/sessions/:sessionId', 
  authMiddleware, 
  validationMiddleware({ params: WorkoutSchemas.getSessionParams }), 
  async (c) => {
  try {
    return await deleteWorkoutSession(c, (c.get('validatedParams') as { sessionId: string }).sessionId);
  } catch (error: any) {
