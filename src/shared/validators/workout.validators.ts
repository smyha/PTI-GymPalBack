...
export const validateWorkoutName = (name: string): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
...
export const validateExerciseName = (name: string): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
...
export const validateDuration = (duration: number): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
...
export const validateDifficulty = (difficulty: string): { isValid: boolean; errors: string[] } => {
