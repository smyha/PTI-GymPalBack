...
export const PERSONAL_ROUTES = {
  ...
  UPDATE_DIETARY_PREFERENCES: '/dietary-preferences',
  USER_STATS: '/stats',
...
export const FULL_ROUTES = {
  ...
  PERSONAL: {
    ...
    DIETARY_PREFERENCES: `${BASE_ROUTES.PERSONAL}${PERSONAL_ROUTES.DIETARY_PREFERENCES}`,
    UPDATE_DIETARY_PREFERENCES: `${BASE_ROUTES.PERSONAL}${PERSONAL_ROUTES.UPDATE_DIETARY_PREFERENCES}`,
    USER_STATS: `${BASE_ROUTES.PERSONAL}${PERSONAL_ROUTES.USER_STATS}`,
    UPDATE_USER_STATS: `${BASE_ROUTES.PERSONAL}${PERSONAL_ROUTES.UPDATE_USER_STATS}`,
  },
